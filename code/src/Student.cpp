...
Student::Student() {}
Student::Student(const string &upNumber, const string &name, const list<UCClass> &classes, const queue<Request> &requests) : upNumber_(upNumber), name_(name), classes_(classes){}
